...
params.add_argument('-sampler', 	choices=['sgld','mala', 'hmc'], default='mala')

params.add_argument('-step_size', 	type=float, default=0.01)
...
# params.add_argument('-num_chains', 		type=int, 	default=4)
